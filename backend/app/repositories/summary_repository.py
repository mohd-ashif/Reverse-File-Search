...
class SummaryRepository:
    ...
    def upsert(self, file_id: int, data: dict, organization_id: int | None = None) -> FileSummary:
        ...
        if existing is None:
            existing = FileSummary(file_id=file_id, organization_id=organization_id, **data)
